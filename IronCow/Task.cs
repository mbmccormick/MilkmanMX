    ...
    public class Task : RtmFatElement, INotifyPropertyChanged, IComparable, IComparable<Task>
    {
        ...
        public void ChangeList(TaskList list, VoidCallback callback)
        {
            if (mParent != list)
            {
                ...
                {
                    Rtm.Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, new Windows.UI.Core.DispatchedHandler(() =>
                    {
            ...
            get
            {
                if (this.DueDateTime.HasValue &&
                    ...
                    if (Owner == null)
                        ...
                        return new SolidColorBrush(Color.FromArgb(255, 25, 25, 25));
            }
        }
